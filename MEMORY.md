...
更新时间：2026-09-17（Asia/Shanghai；Mac 会话在 master 之上补了**谋篇模式**（作者可切入的只读讨论态，复用 PreparationService 的方案层），见第 30 节；差距第 2 项「导入旧作」下半场「逐章结构反推」仍是队列头；“继续完成项目”总目标保持暂停）
...
### 第 2 项下半场「逐章反推结构」的起手点（正文入库已完成，见第 29 节）
