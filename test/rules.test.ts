...
describe("代码里没有数字（§10.1 的回退防线）", () => {
  ...
  const REGISTERED = new Map<string, string>([
    ...
    ["L2_TOKEN_BUDGET", "§13.4 段 2 的预算。L2 是最大的可缓存前缀，它涨则每章缓存写入都跟着涨。布局参数。"],
    ["MINOR_CHARACTER_WINDOW_TIGHT", "§13.4 裁剪的深档：次要角色窗口收紧到这么多。同上，是布局不是阈值。"],
    ["L2_TRIM_LADDER", "§13.4 的裁剪档位表 —— 一串（桶大小，每桶限长，次要角色窗口）。它描述的是索引怎么排布，不是故事约束。"],
